...
const tracker = initTracker({
  storage: { prefix: "tennis" },
  rosterSize: 2,
  homeShortcutMap: { 1: "(1)", 2: "(2)" },
  awayShortcutMap: { 1: "(3)", 2: "(4)" },
  defaultEventNames: [
    "Serve - Flat", "Serve - Top Spin", "Serve - Slice", "Serve - Underhand",
    "Flat", "Top Spin", "Slice", "Lob",
    "Drop", "Smash", "Volley", "Half Volley",
  ],
  endpoints: { csv: "/tennis/download_csv", pdf: "/tennis/download_pdf" },
